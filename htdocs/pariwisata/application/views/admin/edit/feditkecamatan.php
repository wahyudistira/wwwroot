...
<div id="content">
    ...
    <h1><img src="<?php echo base_url(); ?>img/icons/posts.png" alt="" />Edit Kecamatan</h1>

    <form action="<?php echo base_url(); ?>index.php/edit/editkecamatan/update" method="POST" name="agendafrom" id="agendaform">
        <div class="bloc">
            <div class="title">Edit Kecamatan</div>
            <div class="content">
                <div class="input">
                    <label for="input1">Nama Kecamatan</label>
                    <?php foreach ($data as $row): ?>
                        <input type="hidden" name="id" value="<?php echo $row->id; ?>"/>
                        <input type="text" id="namaKecamatan" name="nama" value="<?php echo $row->nama; ?>" />
                    <?php endforeach; ?>
                </div>
