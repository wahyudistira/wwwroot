...
--> 
<div id="content">
    <h1><img src="<?php echo base_url(); ?>img/icons/posts.png" alt="" />Data User</h1>
                ...
                <tbody>
                    ...
                    foreach ($data as $row): $i++; ?>
                        ...
                        <tr>
                            ...
                            <td class="actions"><a href="<?php echo base_url(); ?>index.php/edit/edituser/edit/<?php echo $row->id; ?>" title="Edit this content"><img src="<?php echo base_url(); ?>img/icons/edit.png" alt="Edit" /></a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
