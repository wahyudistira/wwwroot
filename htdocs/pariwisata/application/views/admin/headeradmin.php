...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo base_url(); ?>images/pemka.ico" >
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>css/style_1.css" />


        <!-- jQuery AND jQueryUI -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/google/jquery.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>js/google/jquery-ui.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            /*validasi angka dan inputan masih kosong*/ 
            ...
            function saveArc(){
                ...
                document.getElementById('arc').submit();
            }
            ...
            function saveDocu(){
                ...
                if(document.getElementById('select').value == ''){
                    alert('Pilih Kategori dahulu');
                    document.getElementById('select').focus();
                    return false;
                }
                
                document.getElementById('docu').submit();
            }
            ...
            function saveForm(){
                ...
                if(document.getElementById('tgl_selesai').value == ''){
                    alert('Data masih kosong');
                    document.getElementById('tgl_selesai').focus();
                    return false;
                }
        ...
        <script>
            ...
            $(function(){
                ...
                $("#tgl_selesai").change(function(){
                    $("#tgl_selesai").datepicker("option","dateFormat","yy-mm-dd");
                });
            });
        </script>
